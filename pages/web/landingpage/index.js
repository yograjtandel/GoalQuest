...
const landingpage = () => {
  const tasktitle = [
    ...
    },
    {
      ...
      desc: 'Effortlessly track, prioritize, and resolve project tickets. Streamline task management and collaboration with our efficient ticket management solution.',
    },
    {
      icon: <HiOutlineUsers style={{ width: '50px', height: '50px' }} />,
      title: 'Collaborate',
      desc: 'Promote seamless team collaboration in project ticket management. Enhance communication, task coordination, and productivity with our collaborative ticket management solution.',
    },
  ];
  return (
        ...
        <Box py={32} bg={'gray.200'}>
          ...
          >
            ...
            <Text w={'50%'} mb={6} textAlign={'center'}>
              ...
              Productivity with Our Comprehensive Ticket Management Services"
            </Text>
            <Box display={'flex'} justifyContent={'center'} flexWrap={'wrap'}>
              {tasktitle.map((tasktitle) => (
                <Box w={{ base: '100%', md: '33.33%' }} p={2}>
                  <CustomCard
                    footer={false}
                    openDrawer={false}
                    p={0}
